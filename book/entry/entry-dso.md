---
id: urn:swd:toc:v2:entry:dso
title: "Design System Ontology (DSO)"
type: EntryPage
cluster: entry
status: draft
links:
...
- design systems stop being static libraries
...
- → [DSO 01 — Components Are Projections](urn:swd:toc:v2:dso:01)
